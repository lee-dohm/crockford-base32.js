...
class Base32 {
  ...
  static decodeChunk (chunk) {
    ...
    switch (chunk.length) {
      case 2:
        value = (Base32.decodeSingleValue(chunk.charAt(0)) << 3) +
                (Base32.decodeSingleValue(chunk.charAt(1)) >>> 2)
      ...
      case 4:
        value = (Base32.decodeSingleValue(chunk.charAt(0)) << 3) +
                (Base32.decodeSingleValue(chunk.charAt(1)) >>> 2)
        decoded += String.fromCharCode(value)
        value = ((Base32.decodeSingleValue(chunk.charAt(1)) & 3) << 6) +
                (Base32.decodeSingleValue(chunk.charAt(2)) << 1) +
                (Base32.decodeSingleValue(chunk.charAt(3)) >>> 4)
        decoded += String.fromCharCode(value)
        break
      ...
      case 5:
        ...
        value = ((Base32.decodeSingleValue(chunk.charAt(1)) & 3) << 6) +
                ...
                (Base32.decodeSingleValue(chunk.charAt(3)) >>> 4)
        decoded += String.fromCharCode(value)
        value = ((Base32.decodeSingleValue(chunk.charAt(3)) & 15) << 4) +
                (Base32.decodeSingleValue(chunk.charAt(4)) >>> 1)
        decoded += String.fromCharCode(value)
        break
      ...
      case 7:
        ...
        value = ((Base32.decodeSingleValue(chunk.charAt(3)) & 15) << 4) +
                (Base32.decodeSingleValue(chunk.charAt(4)) >>> 1)
        decoded += String.fromCharCode(value)
        value = ((Base32.decodeSingleValue(chunk.charAt(4)) & 1) << 7) +
                (Base32.decodeSingleValue(chunk.charAt(5)) << 2) +
                (Base32.decodeSingleValue(chunk.charAt(6)) >>> 3)
        decoded += String.fromCharCode(value)
        break
      ...
      case 8:
        ...
        value = ((Base32.decodeSingleValue(chunk.charAt(4)) & 1) << 7) +
                ...
                (Base32.decodeSingleValue(chunk.charAt(6)) >>> 3)
        decoded += String.fromCharCode(value)
        value = ((Base32.decodeSingleValue(chunk.charAt(6)) & 7) << 5) +
                (Base32.decodeSingleValue(chunk.charAt(7)))
        decoded += String.fromCharCode(value)
        break
    }
